...
/****************************************************************************/
	...
	{		
		$http.post('http://10.0.2.2/projects/fuel/web/complaint_status.php', {
...
/****************************************************************************/
	...
	$http.post('http://10.0.2.2/projects/fuel/web/complaint_get_all.php')
	.success(function(data, status, headers, config) 
	{
			$scope.business_all_details = data.details;
    });
...
$scope.update_status_con = function(cus_id,field_9) 
	...
	{		
		$http.post('http://10.0.2.2/projects/fuel/web/con_update_status.php',{
...
/****************************************************************************/
	...
	{		
		$http.post('http://10.0.2.2/projects/fuel/web/create_order.php', {
...
/****************************************************************************/
	...
	{		
		$http.post('http://10.0.2.2/projects/fuel/web/order_solution.php', {
...
/************************** View All Requirment *****************************/
/****************************************************************************/
	$http.post('http://10.0.2.2/projects/fuel/web/requirment_get_all.php')
	.success(function(data, status, headers, config) 
	{
		if(data.success == 1)
		{
...
/****************************************************************************/
	...
	{		
		$http.post('http://10.0.2.2/projects/fuel/web/admin_complaint_solution.php', {
...
/************************** View All Requirment *****************************/
/****************************************************************************/
	$http.post('http://10.0.2.2/projects/fuel/web/customer_get.php')
	.success(function(data, status, headers, config) 
	{
		if(data.success == 1)
		{
...
/****************************************************************************/
	...
	{		
        $http.post('http://10.0.2.2/projects/fuel/web/sales_delete.php', 
		{
...
/****************************************************************************/
	...
	{		
		...
		$http.post('http://10.0.2.2/projects/fuel/web/invoice_create.php', {
...
/****************************************************************************/
	...
	{
	$http.post('http://10.0.2.2/projects/fuel/web/products_update.php', {
...
/****************************************************************************/
	...
	$http.post('http://10.0.2.2/projects/fuel/web/products_get.php',{'status':$scope.status})
		.success(function (data, status, headers, config) 
		{
			if(data.success == 1)
			{
...
/****************************************************************************/
	...
	{
	$http.post('http://10.0.2.2/projects/fuel/web/products_add.php', {
...
/****************************************************************************/
	...
	{		
        $http.post('http://10.0.2.2/projects/fuel/web/products_delete.php', 
		{
...
/****************************************************************************/
	...
	{		
		$http.post('http://10.0.2.2/projects/fuel/web/sales_create.php', 
		{'fname': $scope.fname, 'lname':$scope.lname, 'email':$scope.email,
		'password': $scope.password,'plotno': $scope.plotno,
...
/****************************************************************************/
	...
	{
	$http.post('http://10.0.2.2/projects/fuel/web/sales_update.php', {
...
/****************************************************************************/
	...
	{		
        $http.post('http://10.0.2.2/projects/fuel/web/sms_send.php', 
		{
		'password': password
		})
		.success(function(data, status, headers, config) 
